...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ansible rw-language-and-country-codes rw-ispell rw-hunspell racket-mode paredit oz org-trello markdown-mode hy-mode flycheck fill-column-indicator edit-server color-theme-sanityinc-solarized))))
(custom-set-faces
